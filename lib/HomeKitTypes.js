...
Characteristic.PairSetup = function() {
    ...
    this.setProps({
        format: api.hap.Formats.TLV8,
        perms: [api.hap.Perms.READ, api.hap.Perms.WRITE]
    });
    this.value = this.getDefaultValue();
};
...
Service.Battery = function(displayName, subtype) {
...
inherits(Service.Battery, Service);

Service.Battery.UUID = '00000096-0000-1000-8000-0026BB765291';
